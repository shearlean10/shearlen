...
async def ajg():
    ...
    try:
        ...
        await ayra_bot.join_chat("@filmhororseru")
        await ayra_bot.join_chat("@storylangkah")
        await ayra_bot.join_chat("@dKontox")
        await ayra_bot.join_chat("@menjelangmagribfull")
